...
export default function ForgetPin(
  props: PageProps<Extract<KcContext, { pageId: "forget-pin.ftl" }>, I18n>
) {
  ...
  return (
    <Template
      ...
      classes={classes}
      headerNode="Forget Pin"
    >
      <form id="kc-forget-pin-form" action={url.loginAction} method="post" className="flex flex-col">
        {/* Hint Field */}
