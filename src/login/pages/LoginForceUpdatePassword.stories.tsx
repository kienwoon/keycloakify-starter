...
// Create KcPageStory for the "login-force-update-password.ftl" page
const { KcPageStory } = createKcPageStory({ pageId: "login-force-update-password.ftl" });

const meta = {
    title: "login/login-force-update-password.ftl",
