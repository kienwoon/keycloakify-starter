...
// Create KcPageStory for the "login-force-update-pin.ftl" page
const { KcPageStory } = createKcPageStory({ pageId: "login-force-update-pin.ftl" });

const meta = {
    title: "login/login-force-update-pin.ftl",
