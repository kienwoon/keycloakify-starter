...
export default function LoginManualUpdatePin(
  props: PageProps<Extract<KcContext, { pageId: "login-manual-update-pin.ftl" }>, I18n>
) {
  ...
  return (
    ...
    >
      <form id="kc-manual-update-pin-form" action={url.loginAction} method="post" className="flex flex-col">
        {/* New PIN Field */}
