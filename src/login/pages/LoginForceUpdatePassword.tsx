...
export default function LoginForceUpdatePassword(
  props: PageProps<Extract<KcContext, { pageId: "login-force-update-password.ftl" }>, I18n>
) {
  ...
  return (
    ...
    >
      <form id="kc-force-update-password-form" action={url.loginAction} method="post" className="flex flex-col">
        {/* New Password Field */}
